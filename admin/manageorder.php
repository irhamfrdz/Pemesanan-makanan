                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from cart c, login l where c.userid=l.userid and status!='Cart' and status!='Selesai' and status!='Sudah Rating' order by idcart ASC");
											$no=1;
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable2" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from cart c, login l where c.userid=l.userid and status!='Diverifikasi' and status!='Serah Terima' and status!='Cart' and status!='Menunggu Verifikasi Pembayaran' order by idcart ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
											$orderids = $p['orderid'];
												?>
...
?>
                                    ...
                                    <a href="laporan_print.php" target="_blank" class="btn btn-danger">Print <Datag></Datag></a>
                                    </div>
                                    </div>
                                </div>
                            </div>
