<?php 
    ...
    //verif pembayaran
	$itungtrans = mysqli_query($conn, "SELECT * FROM cart WHERE status = 'Menunggu Verifikasi Pembayaran'");
    $itungtrans3 = mysqli_num_rows($itungtrans);
    //Menunggu proses Serah Terima
	$itungpngrmn = mysqli_query($conn, "SELECT * FROM cart WHERE status = 'Diverifikasi'");
    $itungpngrmn2 = mysqli_num_rows($itungpngrmn);
    //Complain
	$itungcomplain = mysqli_query($conn, "SELECT * FROM cart WHERE status = 'Complain'");
    $itungcomplain2 = mysqli_num_rows($itungcomplain);
...
<head>
    ...
    <title>Admin Panel - Dhan MOTOR</title>
                ...
                <div class="menu-inner">
                    <nav>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li><a href="../"><span>Kembali ke Menu Halaman Utama</span></a></li>
							<li>
                                <a href="manageorder.php"><i class="ti-dashboard"></i><span>Kelola Pesanan</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Kelola Restoran
                                    </span></a>
                                <ul class="collapse">
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><i class="fa fa-book"></i></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Konfirmasi Serah Terima</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php echo $itungpngrmn2 ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4" style="margin-top: 20px ;">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><i class="fa fa-book"></i></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Pesanan Komplain</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php echo $itungcomplain2 ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
