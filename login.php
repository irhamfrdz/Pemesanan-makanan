...
<html>
<head>
<title>Kayla Catering - Masuk</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Kayla Catering</a></h1>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Kayla Catering</li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2023 Kayla Catering. All rights reserved</p>
			</div>
		</div>
