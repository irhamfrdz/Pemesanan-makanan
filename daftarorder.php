...
<html>
<head>
<title>Kayla Catering - Daftar Belanja</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Fikry Catering</a></h1>
			</div>
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<?php 
						...
						$brg=mysqli_query($conn,"SELECT DISTINCT(idcart), c.orderid, tglorder, status from cart c, detailorder d where c.userid='$uid' and d.orderid=c.orderid and status!='Cart' and status!='Complain' order by tglorder DESC");
						$no=1;
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert">
						<?php 
						if($b['status']=='Sudah Rating'){
						echo '<a href=invoices.php?id='.$b['orderid'].'>'.$b['orderid'].'</a></td>';
						}else{
						echo '<a href=order.php?id='.$b['orderid'].'>'.$b['orderid'].'</a></td>';
						}?>
						...
						<td class="invert">
							<div class="rem">
								...
								else if($b['status']=='Serah Terima'){
									echo 'Serah Terima |';
									echo '
									<a href="komplain.php?id='.$b['orderid'].'" >
									<span style="color: red;">Komplain</span>
									</a>
									';
								} else if($b['status']=='Selesai'){
									echo '
									<a href="rating.php?id='.$b['orderid'].'" >
									<span style="color: green;">Pesanan Selesai</span>
									<br>
									<span style="color: green;">Nilai Sekarang</span>
									</a>
									';
								} else if($b['status']=='Dibatalkan'){
									echo '<span style="color: red;">Pesanan Dibatalkan</span>';
								}else if($b['status']=='Sudah Rating'){
									echo '<span style="color: Green;">Selesai</span>';
								}else if($b['status']=='Menunggu Verifikasi Pembayaran'){
									echo '<span style="color: Red;">Menunggu Verifikasi Pembayaran</span>';
								}else if($b['status']=='Diverifikasi'){
									echo '<span style="color: Green;">Menunggu Proses Serah Terima</span>';
								}else if($b['status']=='Complain'){
									echo '<span style="color: ;">Complain</span>';
								} else {
									echo '-';
								}
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Fikry Catering</li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2024 Fikry Catering All rights reserved</p>
			</div>
		</div>
