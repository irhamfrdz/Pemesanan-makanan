...
if(isset($_POST['confirm']))
	{
		...
		$kon = mysqli_query($conn,"insert into rating (orderid, idproduk, userid, rating, ulasan, tanggal) 
		values('$idorder','$idproduk','$userid','$rating','$ulasan', CURDATE())");
		if ($kon){
		
		$up = mysqli_query($conn,"update cart set status='Sudah Rating' where orderid='$idorder'");
...
<html>
<head>
<title>Depot Moro Seneng - Nilai Pembelian</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
                ...
                <form method="post">
                    ...
                    ?>
                    <h4 style="margin-top: 20px; margin-bottom: 10px;">Ulasan</h4>
                    <input type="text" name="ulasan" placeholder="Berikan Ulasan Anda" required>
                    
                    <h4 style="margin-top: 20px; margin-bottom: 10px;">Rating</h4>
                    <div style="margin-bottom: 20px;" class="rating">
