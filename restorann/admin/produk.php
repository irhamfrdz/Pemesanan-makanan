    ...
    if ($tipe_file == "image/jpeg" || $tipe_file == "image/png") {
        if ($ukuran_file <= 5000000) {
            if (move_uploaded_file($tmp_file, $path)) {
                ...
                $query = "insert into produk (idkategori, namaproduk, gambar, deskripsi, stok, rate, hargabefore, hargaafter)
			  values('$idkategori','$namaproduk','$pathdb','$deskripsi','$stok','$rate','$hargabefore','$hargaafter')";
...
if (isset($_POST["edit"])) {
    ...
    //   $query = "insert into produk (idkategori, namaproduk, kilometer, tahun_pembuatan, isi_silinder, pajak, deskripsi,  hargaafter)
    //   values('$idkategori','$namaproduk','$kilometer','$tahun_pembuatan','$isi_silinder','$pajak','$deskripsi','$harga')";
    $update = mysqli_query($conn, "UPDATE produk SET namaproduk = '$namaproduk', idkategori = '$idkategori', 
		  deskripsi = '$deskripsi', stok = '$stok', hargaafter = '$harga' WHERE idproduk = '$idproduk'");
};
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="produk.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Stok</label>
                                <input name="deskripsi" type="text" value="<?php echo $p['stok'] ?>" class="form-control" required>
                            </div>
